...
if (ok) {
  console.log(`Contract exported (v${intentModel.meta.version}, ${intentModel.business_rules.length} rules, ${intentModel.entities.filter(e => !e.is_integration).length} entities)`)
} else {
